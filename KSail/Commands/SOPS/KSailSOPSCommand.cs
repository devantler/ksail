  ...
  internal KSailSOPSCommand() : base("sops", "Manage secrets with SOPS")
  {
    ...
    this.SetHandler(async (context) =>
    {
      ...
      try
      {
        ...
        context.ExitCode = await handler.HandleAsync(clusterName, generateKey, showKey, showPublicKey, showPrivateKey, encrypt, decrypt, import, export, token).ConfigureAwait(false);
      }
