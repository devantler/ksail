...
//     {
//       if (await KSailLintCommandHandler.HandleAsync(_config, cancellationToken).ConfigureAwait(false) != 0)
//       {
//         return 1;
//       }
//     }
//     await ProvisionCluster(_config, cancellationToken).ConfigureAwait(false);

//     await InstallFlux(_config, cancellationToken).ConfigureAwait(false);
