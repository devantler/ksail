...
sealed class KSailInitCommand : Command
{
  ...
  readonly MirrorRegistriesOption _mirrorRegistriesOption = new() { Arity = ArgumentArity.ZeroOrOne };
  ...
  public KSailInitCommand() : base("init", "Initialize a cluster")
  {
    ...
    this.SetHandler(async (context) =>
    {
      try
      {
        ...
        config.UpdateConfig("Spec.Project.MirrorRegistries", context.ParseResult.GetValueForOption(_mirrorRegistriesOption));
  ...
  void AddOptions()
  {
    ...
    AddOption(_mirrorRegistriesOption);
