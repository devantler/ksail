...
public class E2ETests : IAsyncLifetime, IDisposable
{
  ...
  [InlineData("--name ksail-advanced-native --distribution native --mirror-registries --flux-post-build-variables")]
  [InlineData("-d k3s")]
  //TODO: Add back --secret-manager sops
  [InlineData("--name ksail-advanced-k3s --distribution k3s --mirror-registries --flux-post-build-variables")]
